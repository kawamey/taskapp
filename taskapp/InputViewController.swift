...
class InputViewController: UIViewController {
    ...
    @IBOutlet weak var categoryTextField: UITextField!  //課題
    ...
    override func viewDidLoad() {
        ...
        categoryTextField.text = task.category   //課題
    }
    ...
    func setNotification(task: Task) {
        ...
        //課題追加
        if task.category == ""{
            content.categoryIdentifier = "(カテゴリーなし)"
        }else {
